case INSTRUCTION_ABCD:
	...
	source_decoded_address_mode_type = DecodeAddressMode(&closure.stuff, &source_decoded_address_mode, &closure.decoded_opcode.operands[0]);

	/* Read source operand. */
	closure.source_value = GetValueUsingDecodedAddressMode(&closure.stuff, source_decoded_address_mode_type, &source_decoded_address_mode);

	/* Decode destination address mode. */
	destination_decoded_address_mode_type = DecodeAddressMode(&closure.stuff, &closure.destination_decoded_address_mode, &closure.decoded_opcode.operands[1]);
