...
InstructionSize Instruction_GetSize(const Instruction instruction)
{
	switch (instruction)
	{
		...
		case INSTRUCTION_ADDA:
			...
			return INSTRUCTION_SIZE_LONGWORD;
		...
		case INSTRUCTION_BSET_DYNAMIC:
			...
			return INSTRUCTION_SIZE_LONGWORD_REGISTER_BYTE_MEMORY;

		case INSTRUCTION_MOVEA:
		case INSTRUCTION_MOVE:
			/* Derived from an odd bitfield. */
			return INSTRUCTION_SIZE_MOVE;

		case INSTRUCTION_EXT:
			return INSTRUCTION_SIZE_EXT;
		...
		case INSTRUCTION_ROD_REGISTER:
			/* Standard. */
			return INSTRUCTION_SIZE_STANDARD;
...
InstructionSourceOperand Instruction_GetSourceOperand(const Instruction instruction)
{
	switch (instruction)
	{
		...
		case INSTRUCTION_DBCC:
		case INSTRUCTION_STOP:
			return INSTRUCTION_SOURCE_IMMEDIATE_DATA;
		...
		case INSTRUCTION_BSET_DYNAMIC:
		case INSTRUCTION_EOR:
			return INSTRUCTION_SOURCE_DATA_REGISTER_SECONDARY;

		case INSTRUCTION_BTST_STATIC:
		case INSTRUCTION_BCHG_STATIC:
		case INSTRUCTION_BCLR_STATIC:
		case INSTRUCTION_BSET_STATIC:
			return INSTRUCTION_SOURCE_IMMEDIATE_DATA_BYTE;

		case INSTRUCTION_PEA:
		case INSTRUCTION_JSR:
		case INSTRUCTION_JMP:
		case INSTRUCTION_LEA:
			return INSTRUCTION_SOURCE_MEMORY_ADDRESS_PRIMARY;

		case INSTRUCTION_MOVE_FROM_SR:
			return INSTRUCTION_SOURCE_STATUS_REGISTER;
		...
		case INSTRUCTION_TRAP:
			...
			return INSTRUCTION_SOURCE_NONE;

		case INSTRUCTION_BRA_WORD:
		case INSTRUCTION_BSR_WORD:
		case INSTRUCTION_BCC_WORD:
			return INSTRUCTION_SOURCE_IMMEDIATE_DATA_WORD;

		case INSTRUCTION_SBCD:
		case INSTRUCTION_ABCD:
		case INSTRUCTION_SUBX:
		case INSTRUCTION_ADDX:
			return INSTRUCTION_SOURCE_BCD_X;

		case INSTRUCTION_OR:
		case INSTRUCTION_SUB:
		case INSTRUCTION_AND:
		case INSTRUCTION_ADD:
			return INSTRUCTION_SOURCE_DATA_REGISTER_SECONDARY_OR_PRIMARY_ADDRESS_MODE;

		case INSTRUCTION_SUBA:
		case INSTRUCTION_CMPA:
		case INSTRUCTION_ADDA:
			return INSTRUCTION_SOURCE_PRIMARY_ADDRESS_MODE_SIZED;

		case INSTRUCTION_CMPM:
			return INSTRUCTION_SOURCE_ADDRESS_REGISTER_PRIMARY_POSTINCREMENT;
		...
		case INSTRUCTION_CMP:
		case INSTRUCTION_TST:
			return INSTRUCTION_SOURCE_PRIMARY_ADDRESS_MODE;

		case INSTRUCTION_DIVU:
		case INSTRUCTION_DIVS:
		case INSTRUCTION_MULU:
		case INSTRUCTION_MULS:
			return INSTRUCTION_SOURCE_PRIMARY_ADDRESS_MODE_WORD;
...
InstructionDestinationOperand Instruction_GetDestinationOperand(const Instruction instruction)
{
	...
	switch (instruction)
	{
		...
		case INSTRUCTION_ROXD_REGISTER:
		case INSTRUCTION_ROD_REGISTER:
			return INSTRUCTION_DESTINATION_DATA_REGISTER_PRIMARY;
		...
		case INSTRUCTION_MULU:
		case INSTRUCTION_MULS:
			return INSTRUCTION_DESTINATION_DATA_REGISTER_SECONDARY;

		case INSTRUCTION_LEA:
		case INSTRUCTION_SUBA:
		case INSTRUCTION_CMPA:
		case INSTRUCTION_ADDA:
			return INSTRUCTION_DESTINATION_ADDRESS_REGISTER_SECONDARY;

		case INSTRUCTION_MOVE:
			return INSTRUCTION_DESTINATION_SECONDARY_ADDRESS_MODE;

		case INSTRUCTION_SBCD:
		case INSTRUCTION_SUBX:
		case INSTRUCTION_ABCD:
		case INSTRUCTION_ADDX:
			return INSTRUCTION_DESTINATION_BCD_X;

		case INSTRUCTION_OR:
		case INSTRUCTION_SUB:
		case INSTRUCTION_AND:
		case INSTRUCTION_ADD:
			return INSTRUCTION_DESTINATION_DATA_REGISTER_SECONDARY_OR_PRIMARY_ADDRESS_MODE;

		case INSTRUCTION_MOVEA:
			return INSTRUCTION_DESTINATION_ADDRESS_REGISTER_SECONDARY_FULL;

		case INSTRUCTION_CMPM:
			return INSTRUCTION_DESTINATION_ADDRESS_REGISTER_SECONDARY_POSTINCREMENT;
		...
		case INSTRUCTION_ROXD_MEMORY:
		case INSTRUCTION_ROD_MEMORY:
			return INSTRUCTION_DESTINATION_PRIMARY_ADDRESS_MODE;

		case INSTRUCTION_ORI_TO_CCR:
		case INSTRUCTION_ANDI_TO_CCR:
		case INSTRUCTION_EORI_TO_CCR:
		case INSTRUCTION_MOVE_TO_CCR:
			return INSTRUCTION_DESTINATION_CONDITION_CODE_REGISTER;

		case INSTRUCTION_ORI_TO_SR:
		case INSTRUCTION_ANDI_TO_SR:
		case INSTRUCTION_EORI_TO_SR:
		case INSTRUCTION_MOVE_TO_SR:
			return INSTRUCTION_DESTINATION_STATUS_REGISTER;

		case INSTRUCTION_MOVEM:
			return INSTRUCTION_DESTINATION_MOVEM;

		case INSTRUCTION_MOVEP:
			return INSTRUCTION_DESTINATION_MOVEP;
		...
		case INSTRUCTION_UNIMPLEMENTED_1:
		case INSTRUCTION_UNIMPLEMENTED_2:
			return INSTRUCTION_DESTINATION_NONE;
	}
